...
@Entity
@Table
public class ActivityMerchandiseTag extends BasicModel {
...
//    public String merchandiseType;
    ...
    public static final Finder<Long, ActivityMerchandiseTag> find = new Finder<>(ActivityMerchandiseTag.class, "ecommerce");
