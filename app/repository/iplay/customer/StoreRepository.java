package repository.iplay.customer;
...
public class StoreRepository extends BasicRepository<Store> {
    ...
    @Override
    public ExpressionList<? extends BaseModel> getExpr(Store model) {
...
/*
    @Override
    public CompletionStage<Optional<Menu>> save(Store model) {
        return supplyAsync(() -> {
            Optional<Store> rtn = Optional.empty();
            if (model.id == null) {
                ...
                Store modelTemp = (Store) getModel(model);
                if (modelTemp != null) {
    ...
    public void shiftParent(Store model) {
        ...
        if (model.parent == null || model.parent.id == null) {
            ...
            Store parent = (Store) getModel(model.parent);
            if (parent != null) {
    ...
    public void resetChild(Store modelFrom, Store modelTo, String modelClass) {
