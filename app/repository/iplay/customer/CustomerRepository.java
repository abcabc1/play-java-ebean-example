...
public class CustomerRepository extends BasicRepository<Customer> {
    ...
    @Override
    public ExpressionList<? extends BaseModel> getExpr(Customer model) {
...
/*
    @Override
    public CompletionStage<Optional<Menu>> save(Customer model) {
        return supplyAsync(() -> {
            Optional<Customer> rtn = Optional.empty();
            if (model.id == null) {
                ...
                Customer modelTemp = (Customer) getModel(model);
                if (modelTemp != null) {
    ...
    public void shiftParent(Customer model) {
        ...
        if (model.parent == null || model.parent.id == null) {
            ...
            Customer parent = (Customer) getModel(model.parent);
            if (parent != null) {
    ...
    public void resetChild(Customer modelFrom, Customer modelTo, String modelClass) {
