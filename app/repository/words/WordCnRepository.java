...
public class WordCnRepository extends BasicSimpleRepository<WordCn> {

    @Inject
    public WordCnRepository(EbeanConfig ebeanConfig, DatabaseExecutionContext executionContext) {
