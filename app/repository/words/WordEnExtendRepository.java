...
public class WordEnExtendRepository extends BasicSimpleRepository<WordEnExtend> {

    @Inject
    public WordEnExtendRepository(EbeanConfig ebeanConfig, DatabaseExecutionContext executionContext) {
